...
const[weight, setWeight] = useState(0)
  ...
  const onSubmit = () => {
    ...
    if (validateForm()) {
      axios
        .post(
          config.serverURL+`/trainer/addBmiReport`,
          {
        ...
        .then((resposne) => {
          ...
          if (result.status == "error" ) {
            ...
            toast.success("Bmi report created successfully");
         
            navigate('/dashboard/trainer/managebmi')
            resetForm();
          }
...
// }, [])
  ...
  return (
    ...
    <div className="screen-wrapper">
      <div className="screen-heading">Create Bmi Report</div>
...
export default CreateBmiReport;
