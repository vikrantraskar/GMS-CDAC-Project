...
const UpdateTrainerPassword = () => {
    ...
    const onSubmit = () => {
        ...
        if (validateForm()) {
            axios
            .post(config.serverURL+ '/trainer/updatePassword', { password: inputFields.password.value }, {
                headers: {
    ...
    return (
        <div className="screen-wrapper">
            <div className="screen-heading">Update Password</div>
...
export default UpdateTrainerPassword
